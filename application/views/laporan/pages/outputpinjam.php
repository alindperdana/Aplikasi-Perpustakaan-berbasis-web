                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            if ($tglkembali >= $tglsekarang or $selisih == 0) {
                                                echo "<span class='label label-warning' style='font-size:13px;'>Di Pinjam</span>";
                                            } else {
                                                echo "<span class='label label-danger' style='font-size:13px;'>Belum Dikembalikan</span>";
                                            }
                                            ?>
                                        </td>
                                        <td class="text-center">
